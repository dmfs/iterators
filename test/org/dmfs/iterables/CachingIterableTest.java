...
public class CachingIterableTest
{
	...
	{
		Iterable<String> i = new CachingIterable<String>(Arrays.asList(new String[] { "a", "1", null, "x", "Testing" }).iterator());
		Iterator<String> i1 = i.iterator();
		assertTrue(i1.hasNext());
	...
	/**
	 * Test that all iterators return correct results when creating and iterating a new one before the others have been fully iterated.
	 */
	@Test
