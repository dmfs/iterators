...
public class ConvertedIteratorTest
{
	...
	public void test()
	{
		...
		assertIterateSame(Arrays.asList(new Integer[] {}).iterator(), new ConvertedIterator<Integer, String>(emptyList.iterator(), converter));
		assertIterateSame(Arrays.asList(new Integer[] { 1, 2, 3, 4, 3, 2, 1 }).iterator(), new ConvertedIterator<Integer, String>(list1.iterator(), converter));
	}
