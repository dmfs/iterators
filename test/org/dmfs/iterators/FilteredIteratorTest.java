...
public class FilteredIteratorTest
{
	...
	public void test()
	{
		...
		assertIterateSame(emptyList.iterator(), new FilteredIterator<String>(emptyList.iterator(), new IteratorFilter<String>()
		{
			@Override
		...
		// filter all elements
		assertIterateSame(emptyList.iterator(), new FilteredIterator<String>(list1.iterator(), new IteratorFilter<String>()
		{
			@Override
			public boolean iterate(String element)
			{
		...
		// filter one element
		assertIterateSame(Arrays.asList(new String[] { "1", "2", "3", "3", "2", "1" }).iterator(), new FilteredIterator<String>(list1.iterator(),
		...
		assertIterateSame(Arrays.asList(new String[] { "2", "3", "3", "2" }).iterator(), new FilteredIterator<String>(list1.iterator(),
			new IteratorFilter<String>()
			{
				@Override
				public boolean iterate(String element)
		...
		assertIterateSame(Arrays.asList(new String[] { "4" }).iterator(), new FilteredIterator<String>(list1.iterator(), new IteratorFilter<String>()
		{
			@Override
			public boolean iterate(String element)
			{
